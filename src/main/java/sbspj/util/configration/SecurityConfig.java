...
import sbspj.security.JwtAccessDeniedHandler;
import sbspj.security.JwtAuthenticationEntryPoint;
import sbspj.security.jwt.JWTConfigurer;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
				...
				.antMatchers("/api/vocab").permitAll()
				.antMatchers("/vcontent/add").permitAll()
				.antMatchers("/vcontent/findAll").permitAll()
